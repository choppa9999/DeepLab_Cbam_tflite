...
DATA_SPLITS = {
    'train': {
        'json_path': '/home/jhha/ha/deeplab/tflite_test/data/robo/train/_annotations.coco.json',
        'image_dir': '/home/jhha/ha/deeplab/tflite_test/data/robo/train'  # train 이미지 폴더 경로
    },
    'valid': {
        'json_path': '/home/jhha/ha/deeplab/tflite_test/data/robo/valid/_annotations.coco.json',
        'image_dir': '/home/jhha/ha/deeplab/tflite_test/data/robo/valid'  # valid 이미지 폴더 경로
    },
    'test': {
        'json_path': '/home/jhha/ha/deeplab/tflite_test/data/robo/test/_annotations.coco.json',
        'image_dir': '/home/jhha/ha/deeplab/tflite_test/data/robo/test'  # test 이미지 폴더 경로
    },
    # 예: 다른 데이터셋을 추가하고 싶을 경우
    # 'per_train': {
    #     'json_path': '/home/jhha/ha/deeplab/tensorflow_cbam_git/data/coco/per_train.json',
    #     'image_dir': '/path/to/your/per_train_images'
    # }
}
    ...
    with tqdm(total=num_total_images, desc=f"Processing {set_name}") as pbar:
        ...
        for img_id, img_info in images.items():
            ...
            if tf_example:
                ...
                if num_images_in_shard >= (num_total_images // num_shards):
                    writer.close()
                    shard_id += 1
